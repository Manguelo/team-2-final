...
#Region "Toolbar Routines"
    ...
    Private Sub tsbRole_Click(sender As Object, e As EventArgs) Handles tsbRole.Click
        'nothing to do here. The user is already in roles
    End Sub
...
#End Region
    ...
    Private Sub LoadSelectedRecord()
        Try
            ...
            End With
        Catch ex As Exception
            MessageBox.Show("Error Loading Role Values: " & ex.ToString, "Program", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    Private Sub lstRoles_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lstRoles.SelectedIndexChanged
        ...
        If blnReloading Then
            Exit Sub
        End If
        If lstRoles.SelectedIndex = -1 Then 'nothing to do nothing selected
            Exit Sub
        End If
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If blnErrors Then
            Exit Sub
        End If
        'if we get this far all of trhe data is good
        With objRoles.CurrentObject
        ...
        Try
            ...
            If intResult = -1 Then 'ID Not Unique!
                MessageBox.Show("RoleID must be unique. Unable to save role record", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
