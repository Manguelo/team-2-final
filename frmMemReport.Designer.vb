...
Partial Class frmMemReport
    ...
    Private Sub InitializeComponent()
        ...
        Me.MEMBERTableAdapter = New STARSORG.STARSDBDataSetTableAdapters.MEMBERTableAdapter()
        Me.STARSDBDataSet1 = New STARSORG.STARSDBDataSet1()
        Me.SECURITYBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.SECURITYTableAdapter = New STARSORG.STARSDBDataSet1TableAdapters.SECURITYTableAdapter()
    ...
    Friend WithEvents MEMBERTableAdapter As STARSDBDataSetTableAdapters.MEMBERTableAdapter
    Friend WithEvents FillByToolStrip As ToolStrip
    Friend WithEvents FillByToolStripButton As ToolStripButton
    Friend WithEvents STARSDBDataSet1 As STARSDBDataSet1
    Friend WithEvents SECURITYBindingSource As BindingSource
    Friend WithEvents SECURITYTableAdapter As STARSDBDataSet1TableAdapters.SECURITYTableAdapter
